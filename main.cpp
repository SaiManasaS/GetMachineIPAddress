...
string convertIPAddrToString(string ipAddress)
{
    string inString = ipAddress;
    string outString = "";
    ...
    // Append the string 'agent_IPaddr' to this string
    outString = inString;

    return outString;
}

string createTopicNameFromIPAddr()
{
    string testString = "";

    testString = convertIPAddrToString(getMachineIPAddr());
...
int __cdecl main()
{
    ...
    cout << "createTopicNameFromIPAddr(): " << createTopicNameFromIPAddr() << endl;
}